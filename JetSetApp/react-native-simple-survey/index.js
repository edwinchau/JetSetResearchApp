...
export class SimpleSurvey extends Component {
    static propTypes = {
        ...
        renderDateInput: PropTypes.func,
    ...
    renderFinishOrNextButton() {
        ...
        try {
            switch (survey[currentQuestionIndex].optional) {
                case true: enabled = true; break;
            }
        } finally {

        }

        // Insert break for optional questions here
    ...
    renderDateInputElement() {
        const { survey, renderDateInput, containerStyle } = this.props;
        const currentQuestionIndex = this.state.currentQuestionIndex;
        const answers = this.state.answers;
        const { questionText, questionId, placeholderText = null } = survey[currentQuestionIndex];
    ...
    renderTimeInputElement() {
        const { survey, renderTimeInput, containerStyle } = this.props;
        const currentQuestionIndex = this.state.currentQuestionIndex;
        const answers = this.state.answers;
        const { questionText, questionId, placeholderText = null } = survey[currentQuestionIndex];
    ...
    render() {
        ...
        switch (survey[currentQuestion].questionType) {
            ...
            case 'DateInput': return this.renderDateInputElement();
            case 'TimeInput': return this.renderTimeInputElement();
            default: return <View />;
        }
    }
}
